...
module.exports = {
  ...
  DATA_SOURCES: [
    ...
    },
    {
      name: 'Gate.io',
      klineUrl: (iv, lim) => {
        const m = { '1m':'1m','3m':'3m','5m':'5m','15m':'15m','30m':'30m','1h':'1h','2h':'2h','4h':'4h','6h':'6h','12h':'12h','1d':'1d','3d':'3d','1w':'1w','1s':'1m' }
    ...
    },
    {
      name: 'Huobi',
      klineUrl: (iv, lim) => {
        const m = { '1m':'1min','3m':'3min','5m':'5min','15m':'15min','30m':'30m','1h':'60min','2h':'2hour','4h':'4hour','6h':'6hour','12h':'12hour','1d':'1day','3d':'3day','1w':'1week','1s':'1min' }
  ...
  SIGNAL_NOTIFY: {
    enabled: true,      // 是否开启推送
    minScore: 60,       // 触发推送的最低评分（更灵敏）
    cooldownSec: 120,   // 推送冷却时间（秒）（2分钟）
  }
}
